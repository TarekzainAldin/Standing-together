          ...
          <div className="flex h-[56px] items-center justify-start w-full px-2">
            ...
            {open && (
              <Link
                ...
                className="hidden md:flex ml-2 items-center gap-2 self-center font-bold text-lg bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent"
              >
                STANDING TOGETHER .
              </Link>
            )}
